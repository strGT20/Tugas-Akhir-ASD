...
public class CompareMonitor {
    public static void main(String[] args) {
        ...
        while (running) {
            System.out.println("====== APLIKASI COMPARE MONITOR ======");
            ...
            switch (pilihanMenu) {
                case 1:
                    ...
                    System.out.println("Cihuyy, monitor baru masuk gudang!");
                    break;
                ...
                case 0:
                    running = false;
                    System.out.println("Terima kasih udah pakai program ini!");
                    break;
